...
import static org.firstinspires.ftc.teamcode.constants.AutoPoses.BlueLong.*;

@Autonomous(name = "AutoBlueLong", preselectTeleOp = "Los Protos")
public class AutoBlueLong extends BaseAutonomous {
    ...
    @Override
    protected Command getPpgShot() { return PurpleProtonRobot.INSTANCE.AutoPPG3LongShot; }
    @Override
    protected Command getPgpShot() { return PurpleProtonRobot.INSTANCE.AutoPGP3LongShot; }
    @Override
    protected Command getGppShot() { return PurpleProtonRobot.INSTANCE.AutoGPP3LongShot; }
    @Override
    protected Command getFinalShot() { return PurpleProtonRobot.INSTANCE.Auto3LongShot; }
}
